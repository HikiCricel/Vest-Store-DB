...
exports.getVests = async function (req, res) {
    try {
...
exports.addVest = async function (req, res) {
    try {
        res.render("../Views/Vests/addVest");
    }
    catch (err) {
...
exports.postAddVest = async function (req, res) {
    try {
        const {
...
exports.editVest = async function (req, res) {
    try {
        ...
        res.render("../Views/Vests/vestEdit", {
            list: result.rows[0]
        });
    } catch (err) {
...
exports.postEditVest = async function (req, res) {
    try {
        const {
...
exports.deleteVest = async function (req, res) {
    try {
        const id = req.params.id;
        const result = await pool.query("DELETE FROM armor_products WHERE id=$1", [id]);
        if (result.rowCount === 0) {
            console.log("No vest deleted with id:", id);
        }
        res.redirect("/list");
